...
tarrie sur le mur guide eau alors qu'elle s'est poursuivie en mai et juin sur le gabion (Figures \ref{bmm_civelle_6} et \ref{bmm_civelle_12}). De plus,le poids moyen des civelles en 2022 est largement supérieur à ceux relevés les années précédentes.
...
\Sexpr{sn(vvv[["AGJ"]][["NCY"]])} anguilles jaunes ont migré sur la passe, ce qui classe cette année comme la \Sexpr{vvv[["AGJ"]][["rank"]]} ème sur \Sexpr{vvv[["AGJ"]][["maxrank"]]} années de suivi. Les migrations d'anguilles jaunes sont extrêmement variables d'une année sur l'autre. Le minimum des migrations a été connu en 2005 avec seulement 878 anguilles
    ...
    nécessaires car il y avait de l'eau dans l'huile, la pompe a été
...
anguilles jaunes de petite taille
...
\ref{str_taille_mois_redress2020} et \ref{str_taille_mois_redress2021}) on observe 
clairement la prédominance des anguilles de l'année en 2013 et 2014, et des arrivées 
plus diffuses en 2010, 2011, 2012, 2016 et 2018. En 2017
 2019 le mode correspondant aux civelles de
 petite taille est absent et ce mode est très faible 2022.
%==========================================================================
\begin{figure}[!ht]
  \begin{center}
