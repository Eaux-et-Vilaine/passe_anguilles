...
\graphicspath{{../../../pdata/traitement_stacomi/rapport_anguille/image/2022/}}
...
visreg::visreg2d(gam_vil1,xvar="time",yvar="yday",plot.type="persp",cond=list(loc="Vilaine_ladder", pigm="VB"), phi=30,theta=270)
...
visreg2d(gamm_s,xvar="time",yvar="yday",plot.type="gg")
...
tiff(file=str_c(imgwd,"FIGURE4.tiff"), width = 8, height = 6, units = 'in', res = 300)
plot(v2,gg=TRUE,
...
# TODO CHANGE 2023 remove[1:10]
YYNEW[,as.character(CY),"00"][1:10] <- YYCY[,"angll"][1:10]
