...
\ref{str_taille_mois_redress2024_in_report}).
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.5\textwidth]{report_df_1996_2024.png}
\caption{Fonctionnement de la passe principale du barrage d'Arzal (gabion en
rive gauche) de 1996 à 2024.}
\label{report_df_1996_2024}
\end{figure}
%==========================================================================
%==========================================================================
\begin{figure}[htpb]
