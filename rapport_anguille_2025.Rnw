...
au barrage d'Arzal. Rapport 2024}, 
...
\qquad \color{vert_clair_BGM}\large{\titlefont Mars 2025}
\end{minipage}
%
...
Les montées de civelles et d'anguilles jaunes sont suivies depuis 1996 au
    ...
    L'objectif de ce rapport est de présenter le bilan du suivi de l'année 2024
...
\caption{La passe à anguilles du mur guide eau, passe secondaire, 2007-2024.}
...
La passe du gabion a fonctionné en continu toute l'année, jusqu'au 4 novembre
où elle a été arrêtée pour cause de travaux sur les gabions aval (Figures
\ref{bmm_civelle_6}, \ref{report_df_1996_2024}, \ref{report_dc_1996_2024}).

La pompe de la passe du mur guide eau s'est arrêtée une nuit début mai. Les
autres arrêts consistent en 4 week-ends, 2 semaines pendant les
pêches électriques de septembre, et au 4 novembre pour les travaux sur les
gabions aval (Figure \ref{bmm_civelle_12}, \ref{report_dc12_1996_2024}).
...
\textcolor{orange_EV}{2024}
Les arrivées semblent avoir été assez précoces, et le quota
consommation a été atteint fin janvier, dans un contexte de faibles demandes
pour les pêches de repeuplement. Ainsi la fin de la saison professionnelle est
intervenue très tôt par rapport aux autres années, dès le 29 février-1er mars.
Malgré cette situation, il n'y a eu sur la passe que peu de
migration lors des interruptions de pêche courant février, 
et peu d’arrivées par la suite en fin de saison, ce qui est inattendu. Le pic
de migration a eu lieu le 7 avril avec 65 kg (Figure
