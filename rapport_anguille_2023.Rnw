...
caractère saisonnier marqué avec une migration très importante en novembre et
supérieures à la moyenne janvier (Figure \ref{figure_saisonnalite_agj} et Figure
\ref{figure_seasonal_agj)}. Les débits de la Vilaine et les coefficients de
...
globalement inférieure à la moyenne interannuelle de mars à juillet et pour les mois d'aout et de decembre. 
...
de civelles en estuaire pour constituer la cohorte de 2022. 
...
2015, 2017 et 2019 le mode correspondant aux civelles de
 petite taille est absent et ce mode est très faible en 2022. En 2023, le
...
\caption{Fonctionnement de la passe de 1996 à 2023.}
...
\caption{Bilan du fonctionnement du dispositif de comptage (piège) de 1996 à
2023.}
