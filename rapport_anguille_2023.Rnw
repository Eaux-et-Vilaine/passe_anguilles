...
au barrage d'Arzal. Rapport 2023}, pdfauthor={Cédric Briand},
pdfsubject={anguille},
...
\graphicspath{{C:/workspace/passe_anguilles/image/2023/}}
...
au barrage d'Arzal, rapport 2023.\\
\vspace{2cm}\\
...
Les montées de civelles et d'anguilles jaunes sont suivies depuis 1996 au
    ...
    L'objectif de ce rapport est de présenter le bilan du suivi de l'année 2023
...
\caption{La passe à anguilles du gabion, passe principale 1996-2023.}
...
\caption{La passe à anguilles du mur guide eau, passe secondaire, 2007-2023.}
...
g<-g+annotation_custom(g1_grob, xmin=1985, xmax=2023, ymin=50, ymax=200)
print(g)
#ggthemr_reset()
dev.off()
@
...
vil<-rbind(cbind("value_std"=NA,"year"=1960:1970),
		vil,
		cbind("value_std"=NA,"year"=c(2012:2014,2016,2017,2018,2019,2020,2021,2022,2023))
)
...
r_df_hist <- choice_c(r_df,
		...
		horodatefin="2023-12-31",
		silent=TRUE)
r_df_hist <- connect(r_df_hist)
# attention très très long
png(filename=paste0(imgwdy,"report_df_1996_2023.png"),width=8,height=20, units="in",res=300)
...
Les arrivées de civelles pour l'année \textcolor{orange_EV}{2023} ont été
...
faible.
Egalement, il est important de noter que le poids moyen des civelles en 2023
est largement supérieur à ceux relevés les années pré‐
cédentes.

Le détail mensuel de la migration de \textcolor{orange_EV}{2023} (en effectif) est donné en annexe aux
...
colnames(lsm[['12']])  <-  c("Mois","Min*","Moyenne*","Max*","N (2023)")
colnames(lsm[['6']])   <-  c("Mois","Min*","Moyenne*","Max*","N (2023)")
#==================== xtable6 ===================================
...
deux passes à anguilles d'Arzal (Figure \ref{str_taille_mois_redress2023}). La
...
absent, et il est très faible en 2022. En 2023, le
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.5\textwidth]{report_df_1996_2023.png}
\caption{Fonctionnement de la passe principale du barrage d'Arzal (gabion en
rive gauche) de 1996 à 2023.}
\label{report_df_1996_2023}
\end{figure}
%==========================================================================
%==========================================================================
\begin{figure}[htpb]
\centering
\includegraphics[width=0.5\textwidth]{report_dc_1996_2023.png} 
...
\textbf{Résumé}\par
    ...
    caractéristiques biologiques des civelles en 2023.\par
    \vspace{8mm}
  \textbf{Abstract}\par
