...
\begin{minipage}{0.8\textwidth}
\begin{center}
\hspace{3cm}{\color{white}{\huge \itshape{Mars 2025}}}
\end{center}
\end{minipage}
\restoregeometry
\clearpage
...
\ref{fbmm_civelle_6}, \ref{report_df_1996_2024}, \ref{report_dc_1996_2024}).
...
gabions aval (Figure \ref{fbmm_civelle_12}, \ref{report_dc12_1996_2024}).
...
couvert l'ensemble de lasaison, car les mesures de gestion saisonnières ont été 
...
puis la migration diminue pour les classes suivantes. 
