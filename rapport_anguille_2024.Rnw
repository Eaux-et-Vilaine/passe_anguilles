...
# write_database(bilPM) #  You have written 10594 rows in the database
...
L'année 2024 est particulière, avec des migrations
sur la passe du mur guide eau (183 kg) très proches de celles de la passe du
gabion (218 kg) (Figures \ref{bmm_civelle_6} et \ref{bmm_civelle_12}).
